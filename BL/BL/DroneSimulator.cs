...
namespace BL
{
    ...
    //    public DroneSimulator(BLImp blImp, int droneId, Action updateDrone, Func<bool> checkStop)
    //    {
    //        var bl = blImp;
    //        var dal = bl.dal;
    ...
    //                                catch (Exception ex) { throw new Exception("Internal error base station", ex); }
    ...
    //                                lock (bl)
    //                                {
    //                                    drone.Status = Enums.DroneStatuses.Available;
